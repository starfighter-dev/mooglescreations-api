...
async function getMediaList() {
   ...
   for (let i = 0; i < posts.length; i++) {
      const media_url = 'https://graph.instagram.com/' + posts[i] + '?access_token=' + token + '&fields=media_url,media_type,permalink,caption,timestamp';
      ...
      connection.query("INSERT INTO instagram_feed VALUES (?) ON DUPLICATE KEY UPDATE media_url=VALUES(media_url), media_type=VALUES(media_type), caption=VALUES(caption), permalink=VALUES(permalink), timestamp=VALUES(timestamp)",
